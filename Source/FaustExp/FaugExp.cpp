...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fCheckbox8, "05", "");
		ui_interface->addCheckButton("glideOn", &fCheckbox8);
		ui_interface->declare(&fCheckbox6, "06", "");
		ui_interface->addCheckButton("oscOnePower", &fCheckbox6);
		ui_interface->declare(&fCheckbox5, "07", "");
		ui_interface->addCheckButton("oscTwoPower", &fCheckbox5);
		ui_interface->declare(&fCheckbox7, "08", "");
		ui_interface->addCheckButton("oscThreePower", &fCheckbox7);
		...
		ui_interface->declare(&fCheckbox1, "25", "");
		ui_interface->addCheckButton("keyTrackOne", &fCheckbox1);
		ui_interface->declare(&fCheckbox0, "26", "");
		...
		ui_interface->declare(&fCheckbox3, "32", "");
		ui_interface->addCheckButton("noiseType", &fCheckbox3);
		ui_interface->declare(&fCheckbox4, "33", "");
		...
		ui_interface->addCheckButton("feedbackOn", &fCheckbox2);
		...
		ui_interface->addCheckButton("on", &fCheckbox9);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow8 = fSlow7 + 0.33333334f * (fSlow6 + -130.81f) * (float(fCheckbox1) + 2.0f * float(fCheckbox0));
		float fThen0 = std::min<float>(16.0f * fSlow7, 2e+04f);
		float fElse0 = 0.0625f * fSlow7;
		float fSlow9 = ((iSlow5) ? fElse0 : fThen0);
		...
		float fSlow19 = float(fCheckbox2);
		float fSlow20 = fSlow19 * fSlow18;
		int iSlow21 = int(float(fCheckbox3));
		float fSlow22 = float(fCheckbox4) * float(fHslider11);
		float fSlow23 = fConst2 * float(fHslider12);
		float fSlow24 = float(fCheckbox5);
		float fSlow25 = fConst2 * float(fHslider13);
		float fSlow26 = float(fCheckbox6);
		float fSlow27 = fConst2 * float(fHslider14);
		float fSlow28 = float(fCheckbox7);
		float fSlow29 = float(fHslider15);
		...
		float fSlow35 = float(fEntry1);
		float fSlow36 = float(fHslider17);
		float fElse4 = 0.5555556f * fSlow36;
		float fSlow37 = ((fSlow6 > fSlow35) ? fElse4 : fSlow36);
		float fSlow38 = fConst2 * std::pow(2.0f, 0.083333336f * float(fHslider18));
		float fSlow39 = ((int(float(fCheckbox8))) ? fSlow35 : fSlow6);
		float fSlow40 = fConst2 * std::pow(2.0f, 0.083333336f * float(fHslider19));
		float fSlow41 = std::pow(2.0f, 0.083333336f * float(fHslider20));
		float fSlow42 = std::pow(2.0f, fSlow33 + -4.0f);
		int iSlow43 = fSlow29 >= 5.0f;
		int iSlow44 = fSlow29 >= 4.0f;
		float fSlow45 = float(fHslider21);
		int iSlow46 = fSlow45 >= 3.0f;
		int iSlow47 = fSlow45 >= 2.0f;
		int iSlow48 = fSlow45 >= 1.0f;
		float fSlow49 = float(fHslider22);
		int iSlow50 = int(fSlow49);
		float fSlow51 = float(fHslider23);
		int iSlow52 = fSlow51 >= 3.0f;
		int iSlow53 = fSlow51 >= 2.0f;
		int iSlow54 = fSlow51 >= 1.0f;
		float fSlow55 = float(fHslider24);
		int iSlow56 = int(fSlow55);
		float fSlow57 = std::pow(2.0f, 0.083333336f * float(fHslider25));
		float fSlow58 = std::pow(2.0f, fSlow55 + -4.0f);
		int iSlow59 = fSlow51 >= 5.0f;
		int iSlow60 = fSlow51 >= 4.0f;
		float fSlow61 = 0.001f * fSlow24;
		float fSlow62 = std::pow(2.0f, fSlow49 + -4.0f);
		int iSlow63 = fSlow45 >= 5.0f;
		int iSlow64 = fSlow45 >= 4.0f;
		float fSlow65 = float(fHslider26);
		int iSlow66 = int(fSlow19);
		float fSlow67 = 1.0f - fSlow18;
		float fSlow68 = ((int(float(fCheckbox9))) ? 0.0f : 1.0f);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			iRec13[0] = iSlow12 * (iRec13[1] + 1);
			fRec14[0] = fSlow13 + fConst3 * fRec14[1];
			float fTemp1 = std::max<float>(1.0f, fConst0 * fRec14[0]);
			fRec15[0] = fSlow8 + fRec15[1] * float(fVec3[1] >= fSlow8);
			fRec16[0] = fSlow14 + fConst3 * fRec16[1];
			fRec17[0] = fSlow15 + fConst3 * fRec17[1];
			float fTemp2 = fRec17[0] * std::max<float>(0.0f, std::min<float>(fRec15[0] / fTemp1, std::max<float>((1.0f - fRec16[0]) * (fTemp1 - fRec15[0]) / std::max<float>(1.0f, fConst0 * fRec12[0]) + 1.0f, fRec16[0])) * (1.0f - float(iRec13[0]) / std::max<float>(1.0f, fConst5 * fRec12[0])));
			float fThen1 = fSlow8 + fTemp2 * fSlow10;
			float fElse1 = fSlow8 - fTemp2 * fSlow16;
			float fTemp3 = std::tan(1.5707964f * std::min<float>(std::max<float>(5e-05f * ((iSlow5) ? fElse1 : fThen1), 0.0f), 1.0f));
			float fTemp4 = fTemp3 + 1.0f;
			fRec18[0] = fSlow17 + fConst3 * fRec18[1];
			fRec20[0] = fConst6 + (fRec20[1] - std::floor(fConst6 + fRec20[1]));
			float fTemp5 = ftbl0mydspSIG0[int(65536.0f * fRec20[0])];
			float fThen2 = fTemp5 * (fRec18[0] + -25.0f) + 25.0f;
			float fTemp6 = ((fRec18[0] <= 25.0f) ? fRec18[0] : fThen2) + -0.707f;
			...
			float fElse3 = 0.049922034f * fRec22[0] + 0.0506127f * fRec22[2] - (0.095993534f * fRec22[1] + 0.004408786f * fRec22[3]);
			fRec23[0] = fSlow23 + fConst3 * fRec23[1];
			fRec24[0] = fSlow25 + fConst3 * fRec24[1];
			fRec25[0] = fSlow27 + fConst3 * fRec25[1];
			fRec27[0] = fConst7 + (fRec27[1] - std::floor(fConst7 + fRec27[1]));
			...
			int iTemp9 = fSlow6 != fVec2[1];
			iVec8[0] = iTemp9;
			int iTemp10 = (iVec8[1] <= 0) & (iTemp9 > 0);
			iRec30[0] = iRec30[1] + 1;
			iRec29[0] = iRec29[1] * (1 - iTemp10) + (iRec30[0] + -1) * iTemp10;
			float fTemp11 = std::max<float>(std::exp(fConst1 * (float(-1 * (iRec30[0] + (-1 - iRec29[0]))) / fSlow37)), 0.01f);
			fRec31[0] = fSlow38 + fConst3 * fRec31[1];
			float fTemp12 = fSlow39 * fTemp11 + fRec31[0] + fSlow6 * (1.0f - fTemp11);
			fVbargraph0 = FAUSTFLOAT(fTemp12);
			float fTemp13 = fTemp12;
			fRec33[0] = fSlow40 + fConst3 * fRec33[1];
			fRec32[0] = fConst2 * (fSlow41 + fRec33[0]) + fConst3 * fRec32[1];
			float fTemp14 = fSlow42 * fRec32[0] * fTemp13 + fVec7[(IOTA0 - iConst11) & 65535];
			...
			float fThen6 = 2.0f * (1.0f - std::fabs(fTemp16)) + -1.0f;
			float fElse6 = fConst13 * fRec34[0] * fTemp14;
			...
			float fThen8 = fTemp28 + fTemp29 * (1.0f - fConst0 / fTemp27);
			float fRec37 = ((iTemp30) ? fTemp28 : fThen8);
			float fElse9 = 2.0f * fRec37 + -1.0f;
			float fTemp31 = ((iSlow34) ? fElse9 : fTemp16);
			float fThen10 = ((iSlow34) ? fElse6 : fThen6);
			float fThen11 = ((iSlow32) ? fTemp31 : fThen10);
			float fElse11 = 0.0f - fTemp31;
			float fThen12 = 2.0f * float(fRec26[0] <= 0.5f) + -1.0f;
			...
			float fThen13 = 2.0f * float(fRec26[0] <= 0.7f) + -1.0f;
			float fElse13 = fConst12 * (fTemp22 - fVec10[(IOTA0 - iTemp33) & 4095] * (fTemp34 + (1.0f - fTemp32)) - (fTemp32 - fTemp34) * fVec10[(IOTA0 - (iTemp33 + 1)) & 4095]);
			float fThen14 = ((iSlow34) ? fTemp26 : fThen12);
			float fElse14 = ((iSlow34) ? fElse13 : fThen13);
			...
			float fThen15 = 2.0f * float(fRec26[0] <= 0.85f) + -1.0f;
			float fElse15 = fConst12 * (fTemp22 - fVec10[(IOTA0 - iTemp36) & 4095] * (fTemp37 + (1.0f - fTemp35)) - (fTemp35 - fTemp37) * fVec10[(IOTA0 - (iTemp36 + 1)) & 4095]);
			float fThen16 = ((iSlow44) ? fElse14 : fThen14);
			float fElse16 = ((iSlow34) ? fElse15 : fThen15);
			float fThen17 = ((iSlow31) ? fElse11 : fThen11);
			float fElse17 = ((iSlow43) ? fElse16 : fThen16);
			fRec40[0] = fConst2 * (fSlow57 + fRec33[0]) + fConst3 * fRec40[1];
			float fTemp38 = fSlow58 * fRec40[0] * fTemp13 + fTemp8;
			...
			float fThen18 = 2.0f * (1.0f - std::fabs(fTemp40)) + -1.0f;
			float fElse18 = fConst13 * fRec41[0] * fTemp38;
			float fTemp50 = ((iSlow56) ? fElse18 : fThen18);
			...
			float fThen20 = fTemp52 + fTemp53 * (1.0f - fConst0 / fTemp51);
			float fRec44 = ((iTemp54) ? fTemp52 : fThen20);
			float fElse21 = 2.0f * fRec44 + -1.0f;
			float fTemp55 = ((iSlow56) ? fElse21 : fTemp40);
			float fThen23 = ((iSlow54) ? fTemp55 : fTemp50);
			float fElse23 = 0.5f * (fTemp50 + fTemp55);
			float fThen24 = 2.0f * float(fRec39[0] <= 0.5f) + -1.0f;
			...
			float fThen25 = 2.0f * float(fRec39[0] <= 0.7f) + -1.0f;
			float fElse25 = fConst12 * (fTemp45 - fVec12[(IOTA0 - iTemp57) & 4095] * (fTemp58 + (1.0f - fTemp56)) - (fTemp56 - fTemp58) * fVec12[(IOTA0 - (iTemp57 + 1)) & 4095]);
			float fThen26 = ((iSlow56) ? fTemp49 : fThen24);
			float fElse26 = ((iSlow56) ? fElse25 : fThen25);
			...
			float fThen27 = 2.0f * float(fRec39[0] <= 0.85f) + -1.0f;
			float fElse27 = fConst12 * (fTemp45 - fVec12[(IOTA0 - iTemp60) & 4095] * (fTemp61 + (1.0f - fTemp59)) - (fTemp59 - fTemp61) * fVec12[(IOTA0 - (iTemp60 + 1)) & 4095]);
			float fThen28 = ((iSlow60) ? fElse26 : fThen26);
			float fElse28 = ((iSlow56) ? fElse27 : fThen27);
			float fThen29 = ((iSlow53) ? fElse23 : fThen23);
			float fElse29 = ((iSlow59) ? fElse28 : fThen28);
			float fTemp62 = fRec23[0] * ((iSlow52) ? fElse29 : fThen29);
			float fTemp63 = fSlow62 * fRec33[0] * fTemp13 + fSlow61 * fTemp62;
			...
			float fThen30 = 2.0f * (1.0f - std::fabs(fTemp65)) + -1.0f;
			float fElse30 = fConst13 * fRec45[0] * fTemp63;
			float fTemp75 = ((iSlow50) ? fElse30 : fThen30);
			...
			float fThen32 = fTemp77 + fTemp78 * (1.0f - fConst0 / fTemp76);
			float fRec48 = ((iTemp79) ? fTemp77 : fThen32);
			float fElse33 = 2.0f * fRec48 + -1.0f;
			float fTemp80 = ((iSlow50) ? fElse33 : fTemp65);
			float fThen35 = ((iSlow48) ? fTemp80 : fTemp75);
			float fElse35 = 0.5f * (fTemp75 + fTemp80);
			float fThen36 = 2.0f * float(fRec38[0] <= 0.5f) + -1.0f;
			...
			float fThen37 = 2.0f * float(fRec38[0] <= 0.7f) + -1.0f;
			float fElse37 = fConst12 * (fTemp70 - fVec14[(IOTA0 - iTemp82) & 4095] * (fTemp83 + (1.0f - fTemp81)) - (fTemp81 - fTemp83) * fVec14[(IOTA0 - (iTemp82 + 1)) & 4095]);
			float fThen38 = ((iSlow50) ? fTemp74 : fThen36);
			float fElse38 = ((iSlow50) ? fElse37 : fThen37);
			...
			float fThen39 = 2.0f * float(fRec38[0] <= 0.85f) + -1.0f;
			float fElse39 = fConst12 * (fTemp70 - fVec14[(IOTA0 - iTemp85) & 4095] * (fTemp86 + (1.0f - fTemp84)) - (fTemp84 - fTemp86) * fVec14[(IOTA0 - (iTemp85 + 1)) & 4095]);
			float fThen40 = ((iSlow64) ? fElse38 : fThen38);
			float fElse40 = ((iSlow50) ? fElse39 : fThen39);
			float fThen41 = ((iSlow47) ? fElse35 : fThen35);
			float fElse41 = ((iSlow63) ? fElse40 : fThen40);
			float fTemp87 = fTemp3 * ((fSlow65 * ((fSlow24 * fTemp62 + fSlow26 * fRec24[0] * ((iSlow46) ? fElse41 : fThen41) + fSlow28 * fRec25[0] * ((iSlow30) ? fElse17 : fThen17)) / std::max<float>(1.0f, 0.8f * (fSlow28 * fRec25[0] + fSlow26 * fRec24[0] + fSlow24 * fRec23[0])) + fSlow22 * ((iSlow21) ? fElse3 : fTemp7)) + fSlow20 * fRec1[1] - 0.16465649f * fTemp6 * (1.0f - fTemp3 / fTemp4) * (fRec10[1] + fTemp3 * (fRec9[1] + fTemp3 * (fRec8[1] + fTemp3 * fRec7[1] / fTemp4) / fTemp4) / fTemp4)) / (0.16465649f * (mydsp_faustpower4_f(fTemp3) * fTemp6 / mydsp_faustpower4_f(fTemp4)) + 1.0f) - fRec7[1]) / fTemp4;
			...
			fRec1[0] = fRec11 * std::max<float>(0.0f, std::min<float>(fRec5[0] / fTemp0, std::max<float>((1.0f - fRec6[0]) * (fTemp0 - fRec5[0]) / std::max<float>(1.0f, fConst0 * fRec2[0]) + 1.0f, fRec6[0])) * (1.0f - float(iRec3[0]) / std::max<float>(1.0f, fConst5 * fRec2[0])));
			float fTemp91 = fSlow20 * fRec1[0];
			fVec15[0] = fTemp91;
			fRec0[0] = 0.0f - (0.1f * (fRec0[4] - fVec15[1]) + 0.5f * (fRec0[5] - fVec15[3]));
			float fTemp92 = fRec0[0] - fRec0[1];
			float fThen42 = (std::log(std::min<float>(3.4028235e+38f, coshf(fRec0[0]))) - std::log(std::min<float>(3.4028235e+38f, coshf(fRec0[1])))) / fTemp92;
			float fElse42 = tanhf(0.5f * (fRec0[0] + fRec0[1]));
			float fElse43 = fSlow67 * fRec1[0];
			float fTemp93 = ((iSlow66) ? fElse43 : fRec1[0]);
			fVec16[0] = fTemp93;
			float fTemp94 = fTemp93 - fVec16[1];
			float fThen44 = (std::log(std::min<float>(3.4028235e+38f, coshf(fTemp93))) - std::log(std::min<float>(3.4028235e+38f, coshf(fVec16[1])))) / fTemp94;
			float fElse44 = tanhf(0.5f * (fTemp93 + fVec16[1]));
			float fTemp95 = fSlow69 * fSlow68 * (((std::fabs(fTemp94) <= fConst1) ? fElse44 : fThen44) + ((std::fabs(fTemp92) <= fConst1) ? fElse42 : fThen42));
