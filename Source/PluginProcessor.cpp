    ...
    m_params(*this, nullptr, juce::Identifier("FAUG"),
        {
            ...
            std::make_unique<juce::AudioParameterFloat>(FREQ, "Freq", 1.f,10000.f, 440.f),
            std::make_unique<juce::AudioParameterFloat>(PREV_FREQ, "PrevFreq", 1.f,10000.f, 440.f),
            std::make_unique<juce::AudioParameterFloat>(GLIDE, "Glide", 0.001, 9.25, .01), // 1ms - ~10sec
